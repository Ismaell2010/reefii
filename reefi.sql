...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 08, 2022 at 05:00 PM
...
(5, '2022_04_07_141123_create_meats_table', 1),
(6, '2022_04_07_142911_create_dairies_table', 2),
(7, '2022_04_07_143241_create_others_table', 3),
(8, '2022_04_07_144159_create_orders_table', 4),
(9, '2022_04_07_145139_create_addproducts_table', 5),
(10, '2022_04_07_145825_create_carts_table', 6),
(11, '2022_04_07_150221_create_openions_table', 7),
(12, '2022_04_07_150739_create_openions_table', 8);
...
CREATE TABLE `openions` (
  ...
  `website_rate` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `products_rate` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `service_rate` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Indexes for table `openions`
--
ALTER TABLE `openions`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `openions`
--
ALTER TABLE `openions`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
